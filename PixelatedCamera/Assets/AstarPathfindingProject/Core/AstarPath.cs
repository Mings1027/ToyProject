...
public class AstarPath : VersionedMonoBehaviour {
	...
	private void Start()
	{
		_notNull = active != null;
		_isactiveNotNull = active != null;
		_isactiveNull = active == null;
	}
	...
	public static void FindAstarPath () {
		...
		if (_isactiveNull) active = GameObject.FindObjectOfType<AstarPath>();
		if (_isactiveNotNull && (active.data.graphs == null || active.data.graphs.Length == 0)) active.data.DeserializeGraphs();
	}
	...
	public static string[] FindTagNames () {
		FindAstarPath();
		return _notNull? active.GetTagNames () : new string[1] { "There is no AstarPath component in the scene" };
	}
	...
	private static bool _isactiveNull;
	private static bool _isactiveNotNull;
	private static bool _notNull;
